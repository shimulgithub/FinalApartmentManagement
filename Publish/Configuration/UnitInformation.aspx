<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="UnitInformation.aspx.cs" Inherits="AMS.Configuration.UnitInformation" %>
                ...
                <div class="widget-header">
                    <div class="col-md-5">
                        <h4 class="widget-title">
                            <i class="icon-th"></i>&nbsp;Unit Information</h4>
                    </div>
                            ...
                            <div class="col-md-12" style="text-align: left;">
                               <div class="row">
                                    <div class="col-md-3" style="font-weight: bold; text-align: right;">
                                        &nbsp;<asp:Label ID="lblBuildingConstructionYear" runat="server" Text="Floor Name :"></asp:Label>
                                    </div>
                                    <div class="col-md-6" style="text-align: left;">
                                        <asp:DropDownList ID="ddlFloor" runat="server" CssClass="select2">
                                ...
                                <div class="row">
                                    <div class="col-md-3" style="font-weight: bold; text-align: right;">
                                        &nbsp;<asp:Label ID="lblName" runat="server" Text="Unit Name :"></asp:Label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUnitName"
                                            ErrorMessage="Sorry! User Group Full name required" Text="*" ForeColor="Red"
                                            ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-md-6">
                                        <asp:TextBox ID="txtUnitName" runat="server" Text="" placeholder="Unit Name" CssClass="form-control"></asp:TextBox>&nbsp;&nbsp;
                                    </div>
