<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="BuildingReports.aspx.cs" Inherits="AMS.Reports.BuildingReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="table-header">
                <div class="row">
                    <div class="col-sm-8" style="text-align: left;">
                        <i class="icon-th"></i>&nbsp; Building Information
                    </div>
                </div>
            </div>
                        ...
                        <div id="dvTab">
                         <asp:Button ID="btnVersion" Visible="false" Text="Version Name" runat="server" OnClick="btnVersion_Click"
                            ...
                            <asp:Button ID="btnColumns" Text="Columns View" runat="server" OnClick="btnColumns_Click"
                                Font-Bold="true" Font-Size="14px" CssClass="btn btn-purple" Style="font-weight: bold;
                                font-size: 14px;" />
                            <asp:Button ID="btnModule" Text="Filter" Visible="false" runat="server" OnClick="btnModule_Click"
                                Font-Bold="true" Font-Size="14px" CssClass="btn btn-purple" Style="font-weight: bold;
                                font-size: 14px;" />
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div style="width: 100%; overflow: auto;">
                            <asp:GridView ID="gvBuidingInformation" runat="server" AutoGenerateColumns="false"
                                PageSize="10" AllowSorting="true" AllowPaging="true" CssClass="table table-striped table-bordered table-hover"
                                OnSorting="gvBuidingInformation_Sorting" OnPageIndexChanging="gvBuidingInformation_PageIndexChanging"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvBuidingInformation" EventName="Sorting" />
            <asp:AsyncPostBackTrigger ControlID="gvBuidingInformation" EventName="PageIndexChanging" />
            <asp:AsyncPostBackTrigger ControlID="gvBuidingInformation" EventName="RowDataBound" />
