<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="LeaveInfoReports.aspx.cs" Inherits="AMS.Reports.LeaveInfoReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="table-header">
                <div class="row">
                    <div class="col-sm-8" style="text-align: left;">
                        <i class="icon-th"></i>&nbsp; Employee Leave Information
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div style="width: 100%; overflow: auto;">
                            <asp:GridView ID="gvLeaveInformation" runat="server" AutoGenerateColumns="false"
                                PageSize="10" AllowSorting="true" AllowPaging="true" CssClass="table table-striped table-bordered table-hover"
                                OnSorting="gvLeaveInformation_Sorting" OnPageIndexChanging="gvLeaveInformation_PageIndexChanging"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvLeaveInformation" EventName="Sorting" />
            <asp:AsyncPostBackTrigger ControlID="gvLeaveInformation" EventName="PageIndexChanging" />
            <asp:AsyncPostBackTrigger ControlID="gvLeaveInformation" EventName="RowDataBound" />
