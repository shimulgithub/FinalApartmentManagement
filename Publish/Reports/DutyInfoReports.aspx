<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="DutyInfoReports.aspx.cs" Inherits="AMS.Reports.DutyInfoReports" %>
            ...
            <div class="table-header">
                <div class="row">
                    <div class="col-sm-8" style="text-align: left;">
                        <i class="icon-th"></i>&nbsp; Employee Duty Information
                    </div>
                </div>
            </div>
