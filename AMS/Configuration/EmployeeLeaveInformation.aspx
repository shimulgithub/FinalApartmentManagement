<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="EmployeeLeaveInformation.aspx.cs" Inherits="AMS.Configuration.EmployeeLeaveInformation" %>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <h4 class="widget-title">
                                <i class="icon-th"></i>&nbsp;Employee Leave Entry</h4>
                                   ...
                                   <div class="row">
                                     ...
                                     <div class="col-md-6">
                                         <div class="input-group">
                                                <asp:TextBox ID="txtStartDate" placeholder="Leave Start Date" runat="server" CssClass="form-control date-picker"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" style="font-weight: bold; text-align: right;">
                                            <asp:Label ID="Label5" runat="server" Text="Leave Start Time :"></asp:Label>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                     <div class="row">
                                      <div class="col-md-6" style="font-weight: bold; text-align: right;">
                                       ...
                                       <asp:Label ID="Label1" runat="server" Text="Leave End Date :"></asp:Label>
                                     </div>
                                     <div class="col-md-6">
                                         <div class="input-group">
                                                <asp:TextBox ID="txtLeaveEndDate" placeholder="Leave End Date" runat="server" CssClass="form-control date-picker"
                                                    onKeyPress="return disableEnterKey(event)"></asp:TextBox>
                                                <span class="input-group-addon"><i class="icon-calendar bigger-110"></i></span>
                                            </div>
                                      </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" style="font-weight: bold; text-align: right;">
                                            <asp:Label ID="Label2" runat="server" Text="Leave End Time :"></asp:Label>
                                        </div>
                                        <div class="col-md-6">
                                             <div class="input-group bootstrap-timepicker">
                                        <asp:TextBox ID="txtLeaveEndTime" CssClass="form-control timepicker1" runat="server" placeholder="Time"></asp:TextBox>
                                        <span class="input-group-addon"><i class="icon-time bigger-110"></i></span>
                                    </div>
                                    ...
                                    <div class="space-4">
                                     ...
                                     <div class="col-md-6">
                                        <asp:DropDownList ID="ddlLeaveType" runat="server" CssClass="select2" AutoPostBack="True">
