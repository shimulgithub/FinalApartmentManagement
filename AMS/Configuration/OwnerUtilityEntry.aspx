<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="OwnerUtilityEntry.aspx.cs" Inherits="AMS.Configuration.OwnerUtilityEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <h4 class="widget-title">
                                <i class="icon-th"></i>&nbsp;Owner Utility Entry</h4>
            ...
            <div class="row">
                    <div class="col-md-12" style="text-align: left;">
                        <div class="page-content" style="background: #EFF3F8 none repeat scroll 0 0;">
                           <asp:GridView ID="gvOwnerUtilityInformationList" runat="server" 
                            AutoGenerateColumns="false" 
                            OnRowEditing="gvOwnerUtilityInformationList_RowEditing"
                            OnRowDeleting="gvOwnerUtilityInformationList_RowDeleting"                                               
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvOwnerUtilityInformationList" EventName="RowEditing" />
            <asp:AsyncPostBackTrigger ControlID="gvOwnerUtilityInformationList" EventName="RowDeleting" />
