<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="MeetingInformationEntry.aspx.cs" Inherits="AMS.Configuration.MeetingInformationEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <h4 class="widget-title">
                                <i class="icon-th"></i>&nbsp;Meeting Information Entry</h4>
            ...
            <div class="row">
                    <div class="col-md-12" style="text-align: left;">
                        <div class="page-content" style="background: #EFF3F8 none repeat scroll 0 0;">
                           <asp:GridView ID="gvMeetingInformationList" runat="server" 
                            AutoGenerateColumns="false" 
                            OnRowEditing="gvMeetingInformationList_RowEditing"
                            OnRowDeleting="gvMeetingInformationList_RowDeleting"                                               
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvMeetingInformationList" EventName="RowEditing" />
            <asp:AsyncPostBackTrigger ControlID="gvMeetingInformationList" EventName="RowDeleting" />
