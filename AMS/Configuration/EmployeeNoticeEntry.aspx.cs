...
{
    public partial class EmployeeNoticeEntry : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["UserID"] != null)
            {
                ...
                {
                    Session["breadcrumb"] = "";
                    Session["breadcrumb"] = "Settings>Employee Notice Entry";
        ...
        private void SetDataToControls(EmployeeNoticeInformationBOL oEmployeeNoticeInformationBOL)
        {
            ...
            try
            {
                txtDate.Text = oEmployeeNoticeInformationBOL.DateBind.ToString();
            }
            catch
            {
                txtDate.Text = "";
            ...
            try
            {
                txtDescription.Text = oEmployeeNoticeInformationBOL.Description.ToString();
            }
            catch
            {
                txtDescription.Text = "";
            ...
            try
            {
                txtTitle.Text = oEmployeeNoticeInformationBOL.Title.ToString();
            }
            catch
            {
                txtTitle.Text = "";
