...
{
    public partial class DutyInfoReports : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["UserID"] != null)
            {
                if (!Page.IsPostBack)
                {
                    ...
                    Session["breadcrumb"] = "Reports > Employee Duty Information";
        ...
        private void BindTableColumns()
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = @"SELECT [AutoID] ,[HeaderValue],[HeaderText] ,[Order_Priority]FROM [DB_AMS].[dbo].[TB_AMS_EmployeeDutyInformation_Header]  order by Order_Priority asc ";
        ...
        protected void gvDetails_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (gvRow.RowType == DataControlRowType.Header)
            {
                ...
                cell0.Text = "Employee Duty Information";
        ...
        private void BindEmployeeLeaveInformationList_Selected()
        {
            ...
            try
            {
                ...
                string sql = "SP_TB_Rpt_AMS_EmployeeDutyInformationList";
