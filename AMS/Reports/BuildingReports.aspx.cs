...
{
    public partial class BuildingReports : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
             if (Session["UserID"] != null)
             {
                    ...
                    Session["breadcrumb"] = "Reports > Building Information";
                    //hfpageid.Value = "1020";
        ...
        protected void btnClearfilteringcriteria_Click(object sender, EventArgs e)
        {
            ...
            Session["iTotalRecords"] = 0;
            BindTableColumns();
            gvBuidingInformation.DataSource = null;
            gvBuidingInformation.EmptyDataText = "No Data Show";
            gvBuidingInformation.DataBind();
            gvBuidingInformation.Columns.Clear();
        ...
        private void BindTableColumns()
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = @"SELECT [AutoID] ,[HeaderValue],[HeaderText] ,[Order_Priority]FROM [DB_AMS].[dbo].[TB_AMS_BuildingInformation_Header]  order by Order_Priority asc ";
        ...
        protected void ShowGrid(object sender, EventArgs e)
        {
            ...
            foreach (System.Web.UI.WebControls.ListItem item in chkFields.Items)
            {
                ...
                if (item.Selected)
                {
                    ...
                    gvBuidingInformation.Columns.Add(b);
        ...
        protected void gvBuidingInformation_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            gvBuidingInformation.PageIndex = e.NewPageIndex;

            if (Session["SortedView"] != null)
            {
                DataTable dataTable = new DataTable();
                gvBuidingInformation.DataSource = (DataView)Session["SortedView"];

                int iTotalRecords = ((DataView)(gvBuidingInformation.DataSource)).Count;     //Convert.ToInt32(Session["iTotalRecords"].ToString());  //
                int iEndRecord = gvBuidingInformation.PageSize * (gvBuidingInformation.PageIndex + 1);
                int iStartsRecods = iEndRecord - gvBuidingInformation.PageSize;
                ...
                if (gvBuidingInformation.Rows.Count < 1)
                {
                    gvBuidingInformation.EmptyDataText = "No Data Found";
                }
                gvBuidingInformation.DataBind();
            }
            else
            {
                BindBuildingInformationList_Selected();
                if (gvBuidingInformation.Rows.Count < 1)
                {
                    gvBuidingInformation.EmptyDataText = "No Data Found";
                }
        ...
        protected void gvDetails_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (gvRow.RowType == DataControlRowType.Header)
            {
                ...
                cell0.Text = "Building Information";
                ...
                gvBuidingInformation.Controls[0].Controls.AddAt(0, gvrow);
            }
        }
        private void BindBuildingInformationList_Selected()
        {
            DataTable dt = new DataTable();
            dt = null;
            gvBuidingInformation.DataSource = null;
            ...
            try
            {
                ...
                string sql = "SP_Rpt_TB_AMS_BuildingInformationList";



                dt = Global.CreateDataTableParameterBuildinginformation(sql);

                gvBuidingInformation.DataSource = dt;
                int iTotalRecords = ((DataTable)(gvBuidingInformation.DataSource)).Rows.Count;
        ...
        protected void gvBuidingInformation_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            if (dataTable != null)
            {
                ...
                gvBuidingInformation.DataSource = sortedView;
                if (gvBuidingInformation.Rows.Count < 1)
                {
                    gvBuidingInformation.EmptyDataText = "No Data Found";
                }
        ...
        private void BuildingInformationList()
        {
            DataTable dt = new DataTable();
            try
            {
        ...
        //private void LoadEmployerIDCons(string param)
        //{
        //    DataTable dt = new DataTable();
        //    string sql = "SP_Employer_ReferenceByConsDDL";
        //    dt = Global.CreateDataTableParameter(sql, param);
        //    ddlConsEmployeeRef.DataSource = dt;
        //    ddlConsEmployeeRef.DataTextField = "Employer_Name";
        //    ddlConsEmployeeRef.DataValueField = "Employer_Ref";
        ...
        {
            DataTable dt = new DataTable("BuildingInformation");
            ...
            try
            {
                ...
                string FileName = "BuildingInformation(" + DateTime.Now.ToString("MM_dd_yyyy_HH_mm_ss") + ").xlsx";
                try
                {
                    var wb = new ClosedXML.Excel.XLWorkbook();
                    var ws = wb.Worksheets.Add(dt2, "BuildingInformation");
        ...
        protected void btnprint_Click(object sender, EventArgs e)
        {
            ...
            this.BindBuildingInformationList_Selected();
