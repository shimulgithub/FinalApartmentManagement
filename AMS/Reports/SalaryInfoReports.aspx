<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="SalaryInfoReports.aspx.cs" Inherits="AMS.Reports.SalaryInfoReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="table-header">
                <div class="row">
                    <div class="col-sm-8" style="text-align: left;">
                        <i class="icon-th"></i>&nbsp; Employee Salary Information
                    </div>
                </div>
            </div>
                        ...
                        <div id="dvTab">
                         <asp:Button ID="btnVersion" Visible="false" Text="Version Name" runat="server" OnClick="btnVersion_Click"
                            ...
                            <asp:Panel ID="pnl2Module" runat="server" Visible="false" class="" Style="padding: 5px;
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <b style="display: none;">Employee ID :</b>
                                          <asp:DropDownList ID="ddlEmployeeID" runat="server" CssClass="select2">
                                        </asp:DropDownList>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div style="width: 100%; overflow: auto;">
                            <asp:GridView ID="gvSalaryInformation" runat="server" AutoGenerateColumns="false"
                                PageSize="10" AllowSorting="true" AllowPaging="true" CssClass="table table-striped table-bordered table-hover"
                                OnSorting="gvSalaryInformation_Sorting" OnPageIndexChanging="gvSalaryInformation_PageIndexChanging"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvSalaryInformation" EventName="Sorting" />
            <asp:AsyncPostBackTrigger ControlID="gvSalaryInformation" EventName="PageIndexChanging" />
            <asp:AsyncPostBackTrigger ControlID="gvSalaryInformation" EventName="RowDataBound" />
