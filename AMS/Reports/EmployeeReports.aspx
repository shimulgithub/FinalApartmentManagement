<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="EmployeeReports.aspx.cs" Inherits="AMS.Reports.EmployeeReports" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="table-header">
                <div class="row">
                    <div class="col-sm-8" style="text-align: left;">
                        <i class="icon-th"></i>&nbsp; Employee Information
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div style="width: 100%; overflow: auto;">
                            <asp:GridView ID="gvEmployeeInformation" runat="server" AutoGenerateColumns="true"
                                PageSize="10" AllowSorting="true" AllowPaging="true" CssClass="table table-striped table-bordered table-hover"
                                OnSorting="gvEmployeeInformation_Sorting" OnPageIndexChanging="gvEmployeeInformation_PageIndexChanging"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvEmployeeInformation" EventName="Sorting" />
            <asp:AsyncPostBackTrigger ControlID="gvEmployeeInformation" EventName="PageIndexChanging" />
            <asp:AsyncPostBackTrigger ControlID="gvEmployeeInformation" EventName="RowDataBound" />
