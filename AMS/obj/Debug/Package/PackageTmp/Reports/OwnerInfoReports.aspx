<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="OwnerInfoReports.aspx.cs" Inherits="AMS.Reports.OwnerInfoReports" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="table-header">
                <div class="row">
                    <div class="col-sm-8" style="text-align: left;">
                        <i class="icon-th"></i>&nbsp; Owner Information
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div style="width: 100%; overflow: auto;">
                            <asp:GridView ID="gvOwnerInformation" runat="server" AutoGenerateColumns="true"
                                PageSize="10" AllowSorting="true" AllowPaging="true" CssClass="table table-striped table-bordered table-hover"
                                OnSorting="gvOwnerInformation_Sorting" OnPageIndexChanging="gvOwnerInformation_PageIndexChanging"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvOwnerInformation" EventName="Sorting" />
            <asp:AsyncPostBackTrigger ControlID="gvOwnerInformation" EventName="PageIndexChanging" />
            <asp:AsyncPostBackTrigger ControlID="gvOwnerInformation" EventName="RowDataBound" />
