<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="FloorReports.aspx.cs" Inherits="AMS.Reports.FloorReports" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <div class="table-header">
                <div class="row">
                    <div class="col-sm-8" style="text-align: left;">
                        <i class="icon-th"></i>&nbsp; Floor Information
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div style="width: 100%; overflow: auto;">
                            <asp:GridView ID="gvFloorInformation" runat="server" AutoGenerateColumns="true"
                                PageSize="10" AllowSorting="true" AllowPaging="true" CssClass="table table-striped table-bordered table-hover"
                                OnSorting="gvFloorInformation_Sorting" OnPageIndexChanging="gvFloorInformation_PageIndexChanging"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvFloorInformation" EventName="Sorting" />
            <asp:AsyncPostBackTrigger ControlID="gvFloorInformation" EventName="PageIndexChanging" />
            <asp:AsyncPostBackTrigger ControlID="gvFloorInformation" EventName="RowDataBound" />
