<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="OwnerNoticeEntry.aspx.cs" Inherits="AMS.Configuration.OwnerNoticeEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <h4 class="widget-title">
                                <i class="icon-th"></i>&nbsp;Owner Notice Entry</h4>
                        </div>
            ...
            <div class="row">
                    <div class="col-md-12" style="text-align: left;">
                        <div class="page-content" style="background: #EFF3F8 none repeat scroll 0 0;">
                           <asp:GridView ID="gvOwnerNoticeInformationList" runat="server" 
                            AutoGenerateColumns="false" 
                            OnRowEditing="gvOwnerNoticeInformationList_RowEditing"
                            OnRowDeleting="gvOwnerNoticeInformationList_RowDeleting"                                               
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvOwnerNoticeInformationList" EventName="RowEditing" />
            <asp:AsyncPostBackTrigger ControlID="gvOwnerNoticeInformationList" EventName="RowDeleting" />
